    ...
    public partial class initialCreate1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), "Example Trip: Visiting Family in Sydney" },
                    { 2, new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), "Example Trip: Visiting Tokyo" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), 1 },
                    { 2, 2, new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), 1 },
                    { 3, 3, new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), 2 },
                    { 4, 4, new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 5, 21, 0, 0, 0, 0, DateTimeKind.Local), 2 }
                });
