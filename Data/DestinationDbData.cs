    ...
    public static class DestinationDbData
    {
        public static void Populate(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Destination>().HasData(
                ...
                new Destination { Id = 102, Name = "Newcastle", CountryID = 1, ImageFilename = "no-image.jpg" },
                new Destination { Id = 103, Name = "Central Coast", CountryID = 1, ImageFilename = "no-image.jpg" },
                new Destination { Id = 104, Name = "Hunter Valley", CountryID = 1, ImageFilename = "no-image.jpg" },
                new Destination { Id = 105, Name = "Nelson Bay", CountryID = 1, ImageFilename = "no-image.jpg" },
                new Destination { Id = 106, Name = "Port Macquarie", CountryID = 1, ImageFilename = "no-image.jpg" },
                // Asia
