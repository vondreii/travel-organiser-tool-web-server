    ...
    public static class CountryDbData
    {
        public static void Populate(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Country>().HasData(
                ...
                // Europe
                new Country { Id = 11, Name = "Belgium", RegionID = 3, ImageFilename = "belgium.jpg" },
                ...
                // North America
                new Country { Id = 20, Name = "Bahamas", RegionID = 4, ImageFilename = "bahamas.jpg" },
                ...
                // South America
                new Country { Id = 25, Name = "Argentina", RegionID = 5, ImageFilename = "argentina.jpg" },
                ...
                // Antarctica
                new Country { Id = 36, Name = "Antarctica", RegionID = 7, ImageFilename = "antarctica.jpg" }
            );
        }
    }
}
